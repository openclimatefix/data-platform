...
(function (LocationType) {
     ...
     */
    LocationType[LocationType["NATION"] = 3] = "NATION";
...
class GetPredictedTimeseriesResponse$Type extends MessageType {
    ...
    create(value) {
        const message = { locationID: "", yields: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class PredictedYield$Type extends MessageType {
    ...
    create(value) {
        const message = { yieldKw: 0, timestampUnix: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class GetPredictedCrossSectionResponse$Type extends MessageType {
    ...
    create(value) {
        const message = { timestampUnix: 0n, yields: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class GetLocationMetadataResponse$Type extends MessageType {
    ...
    create(value) {
        const message = { locationID: "", locationType: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class SiteLocationMetadata$Type extends MessageType {
    ...
    create(value) {
        const message = { latitude: 0, longitude: 0, orientationDeg: 0, tiltDeg: 0, capacityKw: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class RegionLocationMetadata$Type extends MessageType {
    ...
    create(value) {
        const message = { regionName: "", gspName: "", capacityKw: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
...
class NationLocationMetadata$Type extends MessageType {
    ...
    create(value) {
        const message = { nationName: "", capacityKw: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial(this, message, value);
        return message;
