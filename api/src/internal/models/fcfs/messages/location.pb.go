...
// 	protoc        v5.29.3
// source: fcfs/messages/location.proto
...
func (x *CreateSiteRequest) Reset() {
	*x = CreateSiteRequest{}
	mi := &file_fcfs_messages_location_proto_msgTypes[0]
...
func (*CreateSiteRequest) Descriptor() ([]byte, []int) {
	return file_fcfs_messages_location_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateGspRequest) Reset() {
	*x = CreateGspRequest{}
	mi := &file_fcfs_messages_location_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateGspRequest) Descriptor() ([]byte, []int) {
	return file_fcfs_messages_location_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreateLocationResponse) Reset() {
	*x = CreateLocationResponse{}
	mi := &file_fcfs_messages_location_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateLocationResponse) Descriptor() ([]byte, []int) {
	return file_fcfs_messages_location_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetLocationRequest) Reset() {
	*x = GetLocationRequest{}
	mi := &file_fcfs_messages_location_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetLocationRequest) Descriptor() ([]byte, []int) {
	return file_fcfs_messages_location_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetLocationResponse) Reset() {
	*x = GetLocationResponse{}
	mi := &file_fcfs_messages_location_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetLocationResponse) Descriptor() ([]byte, []int) {
	return file_fcfs_messages_location_proto_rawDescGZIP(), []int{4}
}
...
var File_fcfs_messages_location_proto protoreflect.FileDescriptor

const file_fcfs_messages_location_proto_rawDesc = "" +
	"\n" +
	"\x1cfcfs/messages/location.proto\x12\rfcfs.messages\"\x9e\x01\n" +
	...
	"capacityKw\x12\x1a\n" +
	"\bmetadata\x18\x06 \x01(\tR\bmetadataB>Z<github.com/devsjc/fcfs/api/src/internal/models/fcfs/messagesb\x06proto3"

var (
	file_fcfs_messages_location_proto_rawDescOnce sync.Once
	file_fcfs_messages_location_proto_rawDescData []byte
)

func file_fcfs_messages_location_proto_rawDescGZIP() []byte {
	file_fcfs_messages_location_proto_rawDescOnce.Do(func() {
		file_fcfs_messages_location_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_fcfs_messages_location_proto_rawDesc), len(file_fcfs_messages_location_proto_rawDesc)))
	})
	return file_fcfs_messages_location_proto_rawDescData
}

var file_fcfs_messages_location_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_fcfs_messages_location_proto_goTypes = []any{
	(*CreateSiteRequest)(nil),      // 0: fcfs.messages.CreateSiteRequest
	(*CreateGspRequest)(nil),       // 1: fcfs.messages.CreateGspRequest
	(*CreateLocationResponse)(nil), // 2: fcfs.messages.CreateLocationResponse
	(*GetLocationRequest)(nil),     // 3: fcfs.messages.GetLocationRequest
	(*GetLocationResponse)(nil),    // 4: fcfs.messages.GetLocationResponse
}
var file_fcfs_messages_location_proto_depIdxs = []int32{
...
func init() { file_fcfs_messages_location_proto_init() }
func file_fcfs_messages_location_proto_init() {
	if File_fcfs_messages_location_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_fcfs_messages_location_proto_rawDesc), len(file_fcfs_messages_location_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fcfs_messages_location_proto_goTypes,
		DependencyIndexes: file_fcfs_messages_location_proto_depIdxs,
		MessageInfos:      file_fcfs_messages_location_proto_msgTypes,
	}.Build()
	File_fcfs_messages_location_proto = out.File
	file_fcfs_messages_location_proto_goTypes = nil
	file_fcfs_messages_location_proto_depIdxs = nil
}
